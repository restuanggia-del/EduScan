...
export default function App() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-background flex app-shell">
      <Sidebar currentPage={currentPage} onNavigate={setCurrentPage} />
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden app-shell-inner">
        <Header onSearch={setSearchQuery} onNavigate={setCurrentPage} />
        <main className="flex-1 min-h-0 overflow-y-auto app-main">
          {renderPage()}
        </main>
      </div>
      <Toaster richColors position="top-center" />

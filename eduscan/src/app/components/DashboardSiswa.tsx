...
export function DashboardSiswa() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel("absensi-realtime-siswa")
      .on(
        "postgres_changes",
        { event: "INSERT", schema: "public", table: "absensi_siswa" },
        () => fetchDashboardData(),
      )
      .subscribe();
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              <CardTitle>Kehadiran Siswa 7 Hari Terakhir</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Kehadiran Siswa Bulanan</CardTitle>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Aktivitas Absensi Siswa Terbaru</CardTitle>

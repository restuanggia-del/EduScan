...
export function GenerateQR() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Tabs
        value={activeTab}
        onValueChange={(v) => setActiveTab(v as "siswa" | "guru")}
        className="space-y-6"
      >
        <TabsList className="no-print">
          <TabsTrigger value="siswa" className="cursor-pointer">
            Siswa
          </TabsTrigger>
          <TabsTrigger value="guru" className="cursor-pointer">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Generate kartu untuk seluruh siswa ({allStudents.length}{" "}
                  siswa)
                </p>
                <Button
                  className="w-full cursor-pointer"
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="kepala_sekolah_tu">
                      Kepala Sekolah & TU
                    </option>
                  </select>
                </div>
